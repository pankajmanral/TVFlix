...
import { api_key , imageBaseURL , fetchDataFromServer } from "./api.mjs";
...
fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${api_key}&append_to_response=casts,videos,images,releases`,function(movie){
    ...
    <div class="detail-box">
        <div class="detail-content">
            ...
            <div class="meta-list">
                <div class="meta-items">
                    <img src="./Tvflix/assets/images/star.png" width="20" height="20" alt="rating">
        ...
        <div class="title-wrapper">
            <h3 class="title-large">Trialers and Clips</h3>
        </div>
    ...
    fetchDataFromServer(`http://api.themoviedb.org/3/movie/${movieId}/recommendations?api_key=${api_key}&page=1` , addSuggestedMovies);
